...
public class Renderer {
    ...
    private void renderColumn(int numColumn, double heightPerceived) {
        this.screen.verticalLine(numColumn,
                0,
                (int) (RenderUtils.EYE_HEIGHT - heightPerceived/2),
                RenderUtils.GROUND_PIXEL);
        this.screen.verticalLine(numColumn,
                (int) (RenderUtils.EYE_HEIGHT - heightPerceived/2),
                (int) (RenderUtils.EYE_HEIGHT + heightPerceived/2),
                RenderUtils.WALL_PIXEL);
        this.screen.verticalLine(numColumn, (int) (RenderUtils.EYE_HEIGHT+ heightPerceived/2), RenderUtils.SCREEN_HEIGHT,RenderUtils.SKY_PIXEL); //Made with love by AD ♥
    }
    ...
    private double getHeightPerceived(Point origin, double angle,final int direction, Map map) {
